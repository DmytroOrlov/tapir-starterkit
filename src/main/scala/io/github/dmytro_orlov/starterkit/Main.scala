...
import io.github.dmytro_orlov.starterkit.module.db.{LiveUserRepository, UserRepository}
import io.github.dmytro_orlov.starterkit.module.logger.{LiveLogger, Logger => MyLogger}
